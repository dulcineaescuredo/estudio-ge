              ...
              <div style={{position:'relative',marginBottom:12}}>
                ...
                {personaAbierto && personaQ && (
                  <div style={{position:'absolute',top:'100%',left:0,right:0,background:'#fff',border:'1px solid #DDDCDA',borderRadius:8,boxShadow:'0 4px 12px rgba(0,0,0,0.1)',zIndex:20,maxHeight:260,overflowY:'auto',marginTop:2}}>
                    ...
                    <div onMouseDown={e=>{e.preventDefault();setCcApellido('');setCcNombrePila(personaQ.toUpperCase());setCrearContactoAbierto(true);setPersonaAbierto(false);}}
...
function Pluma({ perfil, perfilesEstudio = [], clientes = [], expedientes = [] }) {
  ...
  const [generarForm, setGenerarForm] = useState({ tipo: '', cliente_id: '', expediente_id: '', instrucciones: '', tipo_proceso_demanda: '', personeria: '', objeto: '', hechos: '', fundamento_legal: '', peticion: '', prueba: '', danio_moral: false, danio_moral_detalle: '', jurisprudencia: false, jurisprudencia_fallo: '', jurisprudencia_extracto: '', comentarios_adicionales: '', abogados_interponen: [] });
  ...
  return (
    <div>
      <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',gap:12,flexWrap:'wrap',marginBottom:20}}>
        ...
        <button onClick={()=>{setGenerarForm({tipo:todasLasCarpetas[0]||'',cliente_id:'',expediente_id:'',instrucciones:'',tipo_proceso_demanda:'',personeria:'',objeto:'',hechos:'',fundamento_legal:'',peticion:'',prueba:'',danio_moral:false,danio_moral_detalle:'',jurisprudencia:false,jurisprudencia_fallo:'',jurisprudencia_extracto:'',comentarios_adicionales:'',abogados_interponen:[]});setMatriculasAbogados({});setGenerarError('');setShowGenerarModal(true);}}
